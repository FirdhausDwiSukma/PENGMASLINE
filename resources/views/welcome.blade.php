...
<head>
  ...
  <title>PENGMASLINE | Pengaduan Masyarakat</title>
...
<body class="leading-normal tracking-normal " style="font-family: 'Montserrat', sans-serif">
    <!--Nav-->
    <nav id="header" class="flex items-center justify-between flex-wrap bg-gradient-to-r from-yellow-500 via-red-500 to-pink-500 p-7 px-20">
          <div class="flex items-center flex-shrink-0 text-gray-50 text-base mr-6">
            <img src="https://img.icons8.com/external-icongeek26-outline-colour-icongeek26/64/000000/external-announcement-essentials-icongeek26-outline-colour-icongeek26.png" alt=""
              class="transform transition hover:scale-125 duration-300 ease-in-out" width="20%"/>
            <span class="font-bold tracking-wider text-xl">
              &nbsp PENGMASLINE</span>
          </div>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 text-black p-4 lg:p-0 z-20"
              ...
              <ul class="list-reset lg:flex justify-end flex-1 items-center">
                ...
                <li class="mr-3">
                  <a class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#how">Tatacara</a>
                </li>
                <li class="mr-3">
                  <a class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#profile">About Us</a>
                </li>
              </ul>
              
              <a href="{{ url('register')}}">
              <button
                class="mx-auto lg:mx-0 hover: bg-white text-black font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                Masuk / Daftar
              </button>
            </a>
            </div>
  ...
  <!--Hero-->
  <div class="pb-8 pt-18 px-16 bg-gradient-to-r from-yellow-500 via-red-500 to-pink-500">
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      <!--Left Col-->
      <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left text-gray-50">
        <h1 class="my-4 text-4xl font-bold leading-tight">
          Layanan Pengaduan Masyarakat Online Cangkuang
        </h1>
      ...
      <div class="w-full md:w-3/5 text-center">
        <img class="object-fill mx-30 transform transition hover:scale-110 duration-300 ease-in-out"
  ...
  <!-- How & Tatacara-->
      <!-- Column -->
      <div id="how" class="bg-white-100">
      <section class="bg-white-100"><!-- Start Features -->
            <div class="container mx-auto px-4 py-12 sm:py-16 md:py-20 xl:py-28">
                <div class="space-y-4 text-center mb-10 lg:mb-16">
                    <h2 class="text-4xl md:text-5xl font-semibold">Tatacara Pengaduan</h2>
                    <p class="text-lg md:max-w-md mx-auto">Adapun tatacara atau proses verifikasi pengaduan. Dibawah ini merupakan alur tacara atau proses verifikasi pengaduan</p>
                </div>
                <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-10">
                    <div class="bg-white transition-shadow duration-200 shadow hover:shadow-xl p-6 rounded-lg space-y-6">
                        <div class="bg-white-600 flex items-center justify-center w-12 h-12 rounded-full text-white mx-auto">
                         <img alt="Tulis"
                        ...
                        <div class="space-y-4">
                            <h4 class="text-2xl md:text-3xl font-semibold">1. Tulis Laporan</h4>
                    ...
                    <div class="bg-white transition-shadow duration-200 shadow hover:shadow-xl p-6 rounded-lg space-y-6">
                        ...
                        <div class="space-y-4">
                            <h4 class="text-2xl md:text-3xl font-semibold">2. Proses Verifikasi</h4>
                    ...
                    <div class="bg-white transition-shadow duration-200 shadow hover:shadow-xl p-6 rounded-lg space-y-6">
                        ...
                        <div class="space-y-4">
                            <h4 class="text-2xl md:text-3xl font-semibold">3. Tindak Lanjut</h4>
                    ...
                    <div class="bg-white transition-shadow duration-200 shadow hover:shadow-xl p-6 rounded-lg space-y-6">
                        ...
                        <div class="space-y-4">
                            <h4 class="text-2xl md:text-3xl font-semibold">4. Selesai Pengajuan</h4>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              Team kami Sembagi Arutala membantu kepada masyarakat untuk 
              menyampaikan dan keluhan tentang di daerah.<br /><br />
              Images from:
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <title>Jangkauan Pengaduan</title>
              <path
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                Website pengmasline menerima pengaduan untuk daerah kecamatan Cangkuang, Banjaran . Apabila
                masyarakat daerah cangkuang memiliki pengaduan yang ingin disampainkan bisa laporan di PENGMASLINE.<br /><br />
                Images from:
                <a class="text-orange-500 underline" href="https://undraw.co/"
                  >undraw.co</a
                >
